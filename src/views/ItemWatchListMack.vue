  ...
  >
    <div class="d-flex justify-content-between">
      ...
      <div
        ...
        :class="$function_global.getClassTextColorFromCL(source.cl)"
      >
        <transition
          :name="$function_global.getAnimationNameFromCL(source.cl)"
          mode="out-in"
        >
          <span :key="source.price">
    ...
    <div class="d-flex justify-content-between">
      <div class="text-left text-truncate">{{ source.ten_cong_ty }}</div>
